            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        <li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i><p class="m-0">8 Ahmed Amin, Ad Doqi</p></li>
                        <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:+(20) 101 998 6337">+(20) 101 998 6337</a></p></li>
        ...
        <div class="container py-2">
            <div class="row py-4">
                ...
                <div class="col-lg-7 d-flex align-items-center justify-content-center justify-content-lg-start mb-4 mb-lg-0">
                    <p>IMT School© Copyright 2020. All Rights Reserved.</p>
                </div>

                            ...
                            <div class="owl-item cloned" style="width: 540px; margin-right: 10px;">
                                <div>
                                    <img alt="" class="img-fluid"
                                         src="{{asset('assets/front/img/generic/generic-corporate-3-3-full.jpg')}}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="overflow-hidden mb-2">
                    <h2 class="text-color-dark font-weight-normal text-5 mb-0 pt-0 mt-0 appear-animation animated maskUp appear-animation-visible"
                        ...
                        style="animation-delay: 1200ms;">Who <strong class="font-weight-extra-bold">We Are</strong>
                    </h2>
                </div>
                <p class="appear-animation animated fadeInUpShorter appear-animation-visible"
                   ...
                   style="animation-delay: 1400ms;">IMT School (I Make Technology School) is not a place where you can
